...
const navItems: NavItem[] = [
    ...
    { id: "Projects",path: '/Projects', icon: <PackageOpen className="stroke-2" /> },
        ...
        <div className='flex justify-between items-center p-5 z-50 sticky top-0'>
            ...
            >
                ...
                {copiedMail ? (
                    ...
                    <div
                        className="cursor-pointer flex items-center p-0 border border-gray-300 rounded-md bg-gray-50 hover:bg-gray-100 transition"
            ...
            {!mobileMenuActive ? (
                ...
                (
                    <button
                        onClick={toggleMobileMenu}
                        className={`logo relative transition-all duration-300 ${mobileMenuActive ? 'rounded-3xl' : 'rounded-none'} bg-white flex md:hidden lg:hidden gap-2 p-3`}><X /></button>
                )
            }
